...
CREATE TABLE IF NOT EXISTS `grossPrepago` (
  ...
  `grossPrepagoTipoProducto` varchar(2) DEFAULT NULL,
  `grossPrepagoTecnologia` varchar(4) DEFAULT NULL,
  `grossPrepagoCos` varchar(200) DEFAULT NULL,
  ...
  `grossPrepagoNombreDealer` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `outStockPorHora` (
  `outStockPorHoraAnomes`  varchar(7) DEFAULT NULL,
  `outStockPorHoraFechaStock` varchar(45) NOT NULL,
  `outStockPorHoraAgentId` varchar(25) DEFAULT NULL,
  `outStockPorHoraAgentMovil` varchar(15) DEFAULT NULL,
  ...
  `outStockPorHoraVenta` double DEFAULT '0',
  `outStockPorHoraCompra` double DEFAULT '0',
  ...
  `outStockPorHoraTipoCircuito` varchar(25) DEFAULT NULL,
  `outStockPorHoraSubCanal` varchar(100) DEFAULT NULL,
  ...
  `outStockPorHoraZona` varchar(20) DEFAULT NULL,
